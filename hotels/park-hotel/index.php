...
<head>
    ...
    <title>Entertainment park Hotel</title>
...
<body class="bg-gray-100">
    ...
    <section class="container mx-auto min-h-[764px] p-4">
        <div class="overflow-hidden h-[400px]">
            <img src="/upload/hotel.png" alt="Entertainment park Hotel" class="w-full h-full object-cover">
        </div>
        <h1 class="text-3xl font-bold mt-4">Entertainment park Hotel</h1>
        <p class="mt-2">Indulge in timeless elegance at the Entertainment park Hotel, where you’ll revel in the eternal magic of Entertainment park; refined and reimagined for the most discerning of travelers. From the grandest Victorian architecture to the most enchanting latticework, every delicate detail pulls you deeper into the timeless charm of Entertainment park storytelling.</p>
        <p class="mt-2">Boasting stately accommodations with modern amenities plus live music in the grand 6-story lobby, this architectural marvel combines the splendor of a vintage seaside resort with the magic of Entertainment park.</p>
        <h2 class="text-2xl font-bold mt-6 mb-2">Service Adjustment</h2>
        <p class="mt-2">The new regulation on disposable plastic products starts on April 22, 2024. Under the new regulation, Entertainment park Resort Hotels are prohibited from providing free toiletries packed in disposable plastic containers, toiletries made of plastics, and disposable plastic-bottled water in the guest rooms.</p>
